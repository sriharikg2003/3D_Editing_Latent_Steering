...
def alpha_blend_experiment():
    ...
    new_prompt1 = "A cushioned chair"
    print(f"Encoding new prompt: '{new_prompt1}'")
    ...
    with torch.no_grad():
        ...
        new_cond_dict1 = pipeline.get_cond([new_prompt1])
        new_embedding1 = new_cond_dict1['cond']
        neg_cond1 = new_cond_dict1['neg_cond'] 

    # 4. Setup the Output Directory
    output_dir = "alpha_blend_results_slat_interpol"
    ...
    for alpha in alphas:
        ...
        blended_embedding = ((1-alpha) *new_embedding )+ (alpha * new_embedding1 )
